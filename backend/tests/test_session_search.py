...
class TestSessionSearch:
    ...
    def test_cannot_search_other_users_sessions(self, client):
        ...
        token_a = client.post("/v1/login", json={"email": "search_a@example.com", "password": "pass123"}).json()["access_token"]
        user_b_id = client.post("/v1/login", json={"email": "search_b@example.com", "password": "pass123"}).json()["user_id"]
