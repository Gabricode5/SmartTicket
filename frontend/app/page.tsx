...
const FEATURE_ICONS = [
    <MessageSquare key="assistant" className="h-5 w-5 text-brand" />,
    <BookOpen key="rag" className="h-5 w-5 text-brand" />,
    <Users key="escalation" className="h-5 w-5 text-emerald-600" />,
    <BarChart2 key="analytics" className="h-5 w-5 text-amber-600" />,
    <Activity key="monitoring" className="h-5 w-5 text-brand" />,
    <ShieldCheck key="security" className="h-5 w-5 text-slate-600" />,
]
const FEATURE_BG = ["bg-brand/10", "bg-brand/10", "bg-emerald-50", "bg-amber-50", "bg-brand/10", "bg-slate-100"]
...
const ENTERPRISE_ICONS = [
    <Lock key="security" className="h-5 w-5 text-brand" />,
    <TrendingUp key="scale" className="h-5 w-5 text-brand" />,
    <Users key="teams" className="h-5 w-5 text-emerald-600" />,
    <Headset key="support" className="h-5 w-5 text-amber-600" />,
]
const ENTERPRISE_BG = ["bg-brand/10", "bg-brand/10", "bg-emerald-50", "bg-amber-50"]
        ...
        <div className="force-light min-h-screen bg-white flex flex-col">
            ...
            <section className="relative overflow-hidden bg-gradient-to-br from-slate-50 via-brand/10 to-white pt-20 pb-24 px-6">
                ...
                <div className="max-w-4xl mx-auto text-center relative">
                    <span className="inline-flex items-center gap-2 text-xs font-semibold text-brand bg-brand/10 border border-brand/20 px-3 py-1.5 rounded-full mb-6">
                    ...
                    <p className="mt-5 text-sm text-slate-400">
                        ...
                        <Link href="/chat" className="text-brand font-medium hover:underline">
                ...
                <div className="max-w-2xl mx-auto mt-16 relative">
                    <div className="rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-brand/10 overflow-hidden">
                        ...
                        <div className="p-6 space-y-4">
                            <div className="flex justify-end">
                                <div className="bg-brand text-white text-sm rounded-2xl rounded-tr-sm px-4 py-2.5 max-w-xs">
            ...
            {/* ── CTA final ── */}
            <section className="py-24 px-6 bg-gradient-to-br from-brand-dark to-brand">
