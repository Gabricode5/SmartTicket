# Accord de sous-traitance (DPA) — Tiqia
...
> Tiqia. Ce n'est **pas** un document validé juridiquement — les champs
...
- **[RAISON SOCIALE À COMPLÉTER]**, [FORME JURIDIQUE À COMPLÉTER], dont le siège social
  est situé [ADRESSE À COMPLÉTER], ci-après le « Sous-traitant » ou « Tiqia » ;

Ci-après conjointement désignées « les Parties ».

## Préambule

Le Client utilise le service Tiqia, une plateforme de support client assistée par
intelligence artificielle, dans le cadre de laquelle Tiqia traite, pour le compte du
...
présent accord a pour objet de définir les conditions dans lesquelles Tiqia s'engage
...
## 2. Obligations de Tiqia (sous-traitant)

Conformément à l'article 28.3 du RGPD, Tiqia s'engage à :
...
1. Traiter les données uniquement sur instruction documentée du Client, y compris en ce qui
   ...
   Tiqia informe le Client de cette obligation, sauf interdiction légale) ;
...
5. Compte tenu de la nature du traitement, aider le Client, par des mesures techniques et
   ...
   l'interface Tiqia, de fonctionnalités d'accès, de rectification, de portabilité et
...
6. Aider le Client à garantir le respect des obligations prévues aux articles 32 à 36 du
   ...
   traitement et des informations à disposition de Tiqia ;
...
Le Client autorise de manière générale Tiqia à recourir aux sous-traitants ultérieurs
...
Tiqia informe le Client de tout changement prévu concernant l'ajout ou le
...
Tiqia notifie au Client toute violation de données à caractère personnel dans les
...
Le service Tiqia fournit nativement aux utilisateurs finaux les moyens d'exercer
leurs droits :
...
Lorsqu'une demande est adressée directement à Tiqia plutôt qu'au Client, Tiqia
...
Au terme du contrat commercial, quelle qu'en soit la cause, Tiqia supprime
...
Sur demande raisonnable du Client, Tiqia met à disposition les éléments démontrant sa
